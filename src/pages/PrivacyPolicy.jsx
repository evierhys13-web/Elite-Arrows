    ...
    <div className="page">
      ...
      <div className="card">
        <div style={{ lineHeight: '1.8', color: 'var(--text)' }}>
          ...
          <p style={{ marginBottom: '10px' }}>
            <strong>Code of Conduct:</strong> Elite Arrows maintains a zero-tolerance policy for cheating, harassment, or toxic behavior. Breaking league rules or engaging in unsportsmanlike conduct results in a <strong>one-time final warning</strong>, followed by an <strong>immediate season ban</strong> for any subsequent offense. No second chances — serious or discriminatory abuse results in a <strong>permanent community ban until the offender proves they can behave</strong>.
          </p>
          <p style={{ marginBottom: '15px' }}>
          ...
          <h3 style={{ color: 'var(--accent-cyan)', marginBottom: '10px', marginTop: '25px' }}>9. Changes to This Policy</h3>
          <p style={{ marginBottom: '15px' }}>
