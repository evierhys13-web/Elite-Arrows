    ...
    <div className="page">
      ...
      <div className="card" style={{ marginBottom: '20px' }}>
        ...
        <div style={{ display: 'grid', gap: '12px' }}>
          {[
            { name: 'Daily Grinder', requirement: '5 Practice Sessions in 1 day', reward: 50, icon: '🔥', progress: 3, total: 5 },
            { name: 'Weekly Warrior', requirement: 'Practice 5 days in a week', reward: 200, icon: '⚔️', progress: 2, total: 5 },
            { name: 'ATC Master', requirement: 'Score 100% accuracy in ATC', reward: 500, icon: '🎯', progress: 0, total: 1 }
          ].map((milestone, i) => (
            <div key={i} style={{ padding: '15px', background: 'var(--bg-secondary)', borderRadius: '12px', border: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: '15px' }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '4px' }}>
                  ...
                  <span style={{ color: 'var(--accent-cyan)', fontWeight: 'bold' }}>+{milestone.reward} ET</span>
                </div>
