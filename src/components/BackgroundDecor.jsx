export default function BackgroundDecor() {
  return (
    <div style={{
      ...
      <div className="shooting-star shooting-star-9" />
      <div className="shooting-star shooting-star-10" />
      ...
      <div className="meteor meteor-anim meteor-4" />
      <div className="meteor meteor-anim meteor-5" />
      <div className="meteor meteor-anim meteor-6" />
      <div className="meteor meteor-anim meteor-7" />
      <div className="meteor meteor-anim meteor-8" />
      <div className="meteor meteor-anim meteor-9" />
