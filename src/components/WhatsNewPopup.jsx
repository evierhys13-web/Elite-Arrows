...
const CHANGELOG = [
  ...
  },
  {
    ...
    date: 'June 2026',
    changes: [
      { type: 'feature', title: 'Super League', description: 'The Super League is now available for all subscribed members with Masters and Pro divisions, full standings and regulation tracking.' },
  ...
  },
  {
    ...
    changes: [
      ...
      { type: 'feature', title: 'Super League Beta', description: 'The Super League is now open for all members to view and track.' },
