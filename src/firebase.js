...
import { getFirestore, collection, doc, setDoc, getDoc, getDocs, getDocsFromServer, query, where, orderBy, onSnapshot, deleteDoc, addDoc, updateDoc, writeBatch, runTransaction, deleteField as deleteFieldFirestore } from 'firebase/firestore'
...
export { 
  doc, setDoc, getDoc, getDocs, getDocsFromServer, query, where, orderBy, onSnapshot, deleteDoc, collection, addDoc, updateDoc, writeBatch, runTransaction,
